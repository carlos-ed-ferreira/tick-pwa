...
export default function CalendarPage() {
  ...
  const activeNavigationItemClassName =
    'inline-flex min-h-9 items-center gap-2 rounded-[0.4rem] inset-ring-hairline inset-ring-[#f8d7aa]/70 bg-[#f0c38e] px-3.5 text-sm font-semibold text-[#253241] shadow-[0_12px_28px_rgba(240,195,142,0.16)] transition hover:-translate-y-0.5 hover:inset-ring-[#ffe0b8] hover:bg-[#f5d09f] hover:shadow-[0_16px_34px_rgba(240,195,142,0.22)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#f7d9b0]';
  const navigationItemClassName =
    'inline-flex min-h-9 items-center gap-2 rounded-[0.4rem] inset-ring-hairline inset-ring-transparent px-3.5 text-sm font-medium text-[#b4c1ce] transition hover:inset-ring-white/10 hover:bg-white/8 hover:text-[#fff9f2] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#f7d9b0]';
        ...
        <div className="relative mx-auto flex w-full max-w-[1280px] flex-col gap-4 lg:min-h-0 lg:has-[.calendar-shell]:h-full">
          <header className="grid gap-3 pt-3 sm:pt-4 lg:grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] lg:items-center">
            ...
            <nav className="flex w-full flex-wrap items-center gap-2 sm:w-fit lg:justify-self-center">
              ...
              <div className="flex flex-wrap items-center justify-start gap-1 rounded-[0.5rem] inset-ring-hairline inset-ring-white/10 bg-white/6 p-1.5 shadow-sm shadow-[#253241]/10 backdrop-blur-md">
                <Link
                  href="/calendar"
                  aria-current="page"
