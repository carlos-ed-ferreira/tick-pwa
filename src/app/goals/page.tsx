...
export default function GoalsPage() {
  ...
  const activeNavigationItemClassName =
    'inline-flex min-h-9 items-center gap-2 rounded-[0.5rem] inset-ring-hairline inset-ring-[#f8d7aa]/70 bg-[#f0c38e] px-3.5 text-sm font-semibold text-[#253241] shadow-[0_12px_28px_rgba(240,195,142,0.16)] transition hover:-translate-y-0.5 hover:inset-ring-[#ffe0b8] hover:bg-[#f5d09f] hover:shadow-[0_16px_34px_rgba(240,195,142,0.22)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#f7d9b0]';
  const navigationItemClassName =
    'inline-flex min-h-9 items-center gap-2 rounded-[0.5rem] inset-ring-hairline inset-ring-transparent px-3.5 text-sm font-medium text-[#b4c1ce] transition hover:inset-ring-white/10 hover:bg-white/8 hover:text-[#fff9f2] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#f7d9b0]';
  return (
    <AuthGate>
