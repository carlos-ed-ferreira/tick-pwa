  ...
  if (authMode === 'authenticated') {
    ...
    return (
      <div className="flex flex-wrap items-center gap-2">
        <span
          className="inline-flex min-h-10 max-w-[13rem] items-center gap-2 rounded-full border border-white/10 bg-white/6 px-3.5 text-xs font-medium text-[#d8d0e8] shadow-sm shadow-[#312c51]/10"
          title={email}
        >
          <UserRound
            aria-hidden="true"
