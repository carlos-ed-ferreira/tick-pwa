  ...
  if (authMode === 'authenticated') {
    return (
      <div className="flex flex-wrap items-center gap-2">
        <span className="inline-flex min-h-10 max-w-[13rem] items-center gap-2 rounded-full border border-white/10 bg-white/6 px-3.5 text-xs font-medium text-[#d8d0e8] shadow-sm shadow-[#312c51]/10">
          <UserRound
            aria-hidden="true"
        ...
        <Button
          className="min-h-10 rounded-full border-white/10 bg-white/5 px-4 text-sm text-[#f8f3ea] shadow-sm shadow-[#312c51]/10 hover:-translate-y-0.5 hover:border-white/20 hover:bg-white/10 hover:shadow-md focus-visible:outline-[#f7d9b0]"
          tone="subtle"
          onClick={signOut}
        >
