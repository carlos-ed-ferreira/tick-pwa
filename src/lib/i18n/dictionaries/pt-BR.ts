...
export const ptBRDictionary = {
  ...
  sync: {
    ...
    force: 'Sincronizar agora',
    forcing: 'Sincronizando agora',
  ...
  powerSyncPoc: {
    ...
    siblingLabel: 'Segunda subtarefa',
    ...
    required: 'Preencha os quatro campos.',
    ...
    itemLabel: 'Texto do item',
    itemAction: '{action}: {item}',
    saveItem: 'Salvar texto',
    markComplete: 'Concluir',
    reopenItem: 'Reabrir',
    moveDown: 'Mover para baixo',
    deleteItem: 'Excluir',
    deleteTitle: 'Excluir item da prova',
    confirmDelete:
      'O item e suas subtarefas serão excluídos localmente e enviados pelo PowerSync.',
    connected: 'Conectado ao PowerSync.',
    connecting: 'Conectando ao PowerSync.',
    offline: 'PowerSync offline. As alterações continuam locais.',
    synchronized: 'Fila do PowerSync sincronizada.',
    pendingOperation: '{count} operação aguardando envio.',
    pendingOperations: '{count} operações aguardando envio.',
    mutationError: 'Não foi possível gravar a alteração local.',
  },
  navigation: {
    home: 'Tick',
  ...
  calendar: {
    ...
    ignoredItem: '{count} ignorada',
    ignoredItems: '{count} ignoradas',
  ...
  dayEditor: {
    ...
    bulkDelete: 'Excluir',
    bulkMark: 'Marcar',
    chooseCompletionState: 'Escolher estado da marcação',
    completionIgnoredState: 'Estado ignorado',
    completionLevels: 'Níveis de marcação',
    completionStateCompleted: 'Marcado',
    completionStateIgnored: 'Ignorado',
    completionStateLevel: 'Nível {level} de {levels}',
    completionStateUnchecked: 'Desmarcado',
    settingDisabled: 'Desativado',
    settingEnabled: 'Ativado',
  },
  goalStepEditor: {
