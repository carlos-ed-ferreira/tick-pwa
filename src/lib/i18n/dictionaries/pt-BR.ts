...
export const ptBRDictionary = {
  ...
  dayEditor: {
    ...
    configureRowActions: 'Configurar ações das tarefas',
    dragAndDrop: 'Arrastar e soltar',
    clearSelection: 'Limpar seleção',
    rowActionsTitle: 'Ações da tarefa',
    resetRowActions: 'Restaurar padrão',
  ...
  goalStepEditor: {
    ...
    actionVisible: 'Visível',
    configureRowActions: 'Configurar ações das etapas',
    dragAndDrop: 'Arrastar e soltar',
    clearSelection: 'Limpar seleção',
    rowActionsTitle: 'Ações da etapa',
    resetRowActions: 'Restaurar padrão',
    bulkPriority: 'Prioridade',
    bulkBold: 'Negrito',
    bulkCategory: 'Categoria',
