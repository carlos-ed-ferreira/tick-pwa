...
export const ptBRDictionary = {
  ...
  goals: {
    ...
    introFutureDescription:
      'Organize metas por horizonte: curto, médio e longo prazo.',
    introNowDescription:
      'Acompanhe pendências e metas que precisam de atenção logo.',
    futureTitle: 'Horizontes',
    futureDescription: 'Metas futuras por curto, médio e longo prazo.',
    nowTitle: 'Foco de agora',
    nowDescription: 'Metas e pendências para agir em breve.',
    backToGoalGroups: 'Voltar para grupos de metas',
    addNowGoal: 'Criar card',
    newNowGoalTitle: 'Novo foco',
    nowGoalPlaceholder: 'Nome do card',
    renameNowGoal: 'Renomear card',
