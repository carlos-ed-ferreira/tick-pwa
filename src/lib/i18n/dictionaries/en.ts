...
export const enDictionary = {
  ...
  dayEditor: {
    ...
    confirmBulkDeleteItem: 'You are about to delete {count} selected record.',
    confirmBulkDeleteItems: 'You are about to delete {count} selected records.',
    actionHidden: 'Hidden',
