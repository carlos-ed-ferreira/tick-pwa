...
export function TaskTreeRowActionsMenu({
  ...
  const choiceClassName =
    'min-h-8 w-full rounded-lg border px-2 py-1 text-xs font-medium transition focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#f0c38e]';
  ...
  return (
    <>
      ...
      <Dialog
        ...
        open={isOpen}
        panelClassName="modal-surface--flat sm:h-auto sm:max-h-[min(92vh,760px)] sm:max-w-3xl"
        title={labels.title}
        ...
        <div className="min-h-0 overflow-y-auto p-3 sm:p-5">
          <div className="mb-3 flex justify-end">
            <button
              ...
              onClick={() =>
                onChange({ ...defaultTaskTreeRowActionPreferences })
              }
            >
