...
- Calendário diário: grade mensal com preview de conteúdo por dia, abertura do editor pelo estado da URL em `/calendar?day=YYYY-MM-DD`, criação em lote por intervalo com datas digitadas em `DD-MM-YYYY`, seleção de dias da semana e replicação dos itens nos dias compatíveis, além de limpeza em lote dos itens dos dias filtrados.
