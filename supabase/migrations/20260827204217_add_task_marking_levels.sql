alter table "public"."checklist_items" add column "mark_level" smallint not null default 0;

alter table "public"."goal_steps" add column "mark_level" smallint not null default 0;

alter table "public"."checklist_items" add constraint "checklist_items_mark_level_check" CHECK (((mark_level >= 0) AND (mark_level <= 5))) not valid;

alter table "public"."checklist_items" validate constraint "checklist_items_mark_level_check";

alter table "public"."goal_steps" add constraint "goal_steps_mark_level_check" CHECK (((mark_level >= 0) AND (mark_level <= 5))) not valid;

alter table "public"."goal_steps" validate constraint "goal_steps_mark_level_check";
    ...
    if entity_type = 'categoryTag' then
      ...
      if base_revision is null then
        ...
        values (
          ...
          coalesce((mutation_payload ->> 'mark_level')::smallint, 0),
        ...
        set
          ...
          mark_level = coalesce((mutation_payload ->> 'mark_level')::smallint, 0),
