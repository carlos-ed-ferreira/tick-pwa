CREATE INDEX account_operation_receipts_user_created_at_idx ON public.account_operation_receipts USING btree (user_id, created_at);

set check_function_bodies = off;

CREATE OR REPLACE FUNCTION public.purge_account_operation_receipts(p_user_id uuid DEFAULT NULL::uuid, p_retention interval DEFAULT '7 days'::interval)
 RETURNS integer
 LANGUAGE plpgsql
 SECURITY DEFINER
